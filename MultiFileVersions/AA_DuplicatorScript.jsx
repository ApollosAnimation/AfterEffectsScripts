(function(windowObj) {
    ...
    var mainScript = new File(assetFolder.fsName + "/AA_DuplicatorScript_main.jsx");//Define the specific main script to start loadign dependencies from  //Change the object here when making a new script
    function  mainScriptFunc (windowObj){$.global.AA_Scripts.mainDuplicator(windowObj);}//Define the main function that will be called to make the window

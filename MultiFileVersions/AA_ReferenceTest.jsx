(function(windowObj) {
    ...
    var mainScript = new File(assetFolder.fsName + "/AA_ReferenceTest_main.jsx");//Define the specific main script to start loadign dependencies from
    function  mainScriptFunc (windowObj){$.global.AA_Scripts.mainReferenceTest(windowObj);}//Define the main function that will be called to make the window

(function(windowObj) {
    ...
    var mainScript = new File(assetFolder.fsName + "/AA_EffectsWindowScript_main.jsx");//Define the specific main script to start loadign dependencies from
    function  mainScriptFunc (windowObj){$.global.AA_Scripts.mainEffectsWindow(windowObj);}//Define the main function that will be called to make the window

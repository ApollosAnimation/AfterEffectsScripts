var includedFiles = ["ui/uiElements.jsx", "ui/testUI.jsx", "utils/Testing_Utils.jsx", "utils/Comp_Utils.jsx"];
...
function main(windowObj) {
    ...
    if (allButtons["staggerLayers"]){allButtons["staggerLayers"].onClick = function() {TestObject["staggerLayers"](2,false)};}

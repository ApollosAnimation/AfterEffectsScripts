var includedFiles = ["ui/ReferenceTest_UI.jsx"];//define which UI to pull from directly, along with general UI Elements

var ScriptUI = $.global.AA_Scripts.ReferenceTestUI;//define the specific UI for the rest of the script. To be the specified import from the specific UI

$.global.AA_Scripts.mainReferenceTest = function (windowObj) {

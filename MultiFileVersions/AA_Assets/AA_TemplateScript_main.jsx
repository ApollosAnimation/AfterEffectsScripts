var includedFiles = [ "ui/uiElements.jsx", "ui/TemplateScript_ui.jsx"];//define which UI to pull from directly, along with general UI Elements //Change the object here when making a new script

var ScriptUI = $.global.AA_Scripts.TemplateScript_ui;//define the specific UI for the rest of the script. To be the specified import from the specific UI //Change the object here when making a new script
var UI = $.global.AA_Scripts.UI;//define the general UI for the rest of the script to be the general UI import 

$.global.AA_Scripts.mainTemplateScript = function (windowObj) {//Change where the global variable is stored
